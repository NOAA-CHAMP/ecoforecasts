...
% 
% dedalus@alum.mit.edu, lgramer@upstreamtechnology.com, lew.gramer@noaa.gov, 2001-2016
% 
% Last Saved Time-stamp: <Tue 2016-11-29 11:20:22 Eastern Standard Time lew.gramer>
...
path(path,[MYDOCS 'coral\']);
noaa_aoml_coral_project_path;

% Are we running in Octave (free software) vs. MATLAB?
if ( ~exist('isOctave') )
