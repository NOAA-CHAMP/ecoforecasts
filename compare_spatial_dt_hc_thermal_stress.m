1;
%% SCRIPT COMPARE_SPATIAL_DT_HC_THERMAL_STRESS.m:
%
...
%
% Last Saved Time-stamp: <Tue 2018-12-11 14:40:34 Eastern Standard Time gramer>
...
switch (scenario)
 ...
 case 4,	T = TB;	dts = datenum(2014,[8,9],1);	cmp=wrmcmp;	scenario_desc = 'Mass Bleaching';
end;
