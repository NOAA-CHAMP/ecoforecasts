...
% >> subrgn='MK'; use_habitat_map=true; allow_hard_bottom=true; plot_sites=true; doPrint=false; plot_spatial_dt_hc
%
...
%  subrgn=x{:}; disp(subrgn); plot_spatial_dt_hc; end;
%
% Last Saved Time-stamp: <Fri 2017-12-22 12:33:15 Eastern Standard Time gramer>
