function sd = stokes_drift_2(w,hs,tp,estMethod,H)
%function sd = stokes_drift_2(w,hs,tp,estMethod,H)
%
...
% If ESTMETHOD is 'monismith' or 'mellor', optional H specifies assumed water
% depth (DEFAULT 3 m).
%
% Last Saved Time-stamp: <Wed 2016-11-16 13:10:36 Eastern Standard Time gramer>
  ...
  switch ( estMethod ),
   ...
   case 'ardhuin',
    %%%
    %% Empirical relationship from Arduin et al. 2009
    ...
    % Equation from Arduin et al. 2009
