function [lon,lat,dat,matfname,utmzone] = asc2mat(dataset,coastpath,matpath,reconvert,utmzone)
%function [lon,lat,dat,matfname,utmzone] = asc2mat(dataset,coastpath,matpath,reconvert,utmzone)
%
...
% 20Q for USVI. 
%
% Last Saved Time-stamp: <Tue 2017-01-24 17:53:04 Eastern Standard Time gramer>
