function [fdts, fdat] = anndbcs_preprocess(dts, dat, period, ndays, keepdts, detrend_method)
%function [fdts, fdat] = anndbcs_preprocess(dts, dat, period, ndays, keepdts, detrend_method)
%
...
% 
% Last Saved Time-stamp: <Thu 2009-04-09 23:03:26 Eastern Daylight Time gramer>
