function [station,sm,pc,framedts,fhs] = anndbcs(stnam_or_station,periods,ndays,mapdims,normalrng,nodisplay)
%function [station,sm,pc,framedts,fhs] = anndbcs(stnam_or_station,periods,ndays,mapdims,normalrng,nodisplay)
%
...
%   LOAD_NDBC_DATA,VERIFY_VARIABLE - from ICON/MATLAB 'ecoforecasts' toolbox
%   SET_DATETICK_CURSOR - from Lew's personal stash
%
% Last Saved Time-stamp: <Fri 2009-04-24 02:36:14 Eastern Daylight Time gramer>
