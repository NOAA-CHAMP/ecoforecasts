function Pxxc = plot_spec_confint(dat,Pxx,ConfInt)
%function Pxxc = plot_spec_confint()
%
% Calculate confidence interval for power spectral density estimate
%
% Last Saved Time-stamp: <Sun 2013-09-29 20:30:41 Eastern Daylight Time gramer>
  ...
  k = min(round(2*NW),length(dat));
  k = max(k-1,1);

  Pxxc = Pxx*chi2conf(ConfInt,k);
  Pxxc = Pxxc.';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PRIVATE FUNCTIONS
%  All adapted directly from MATLAB copyrighted code at:
%   MATLABROOT/R2007a/toolbox/signal/signal/private/
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
