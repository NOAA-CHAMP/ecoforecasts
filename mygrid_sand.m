...
DatabasesDir = 'c:/Documents and Settings/gramer/My Documents/MATLAB/ecoforecasts/coast';
...
% pcolor(xx,yy,image_data),set(gca, 'clim',[-1000 0]),shading flat,colormap(jet),colorbar('vert')
% xlabel('longitude'),ylabel('latitude'),title('Smith and Sandwell bathymetry (PC)')
