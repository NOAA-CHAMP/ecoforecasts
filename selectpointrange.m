function xes = selectpointrange(varargin)
%function xes = selectpointrange([xes|fh...])
%
...
%
% Last Saved Time-stamp: <Wed 2016-06-08 13:40:41 Eastern Daylight Time gramer>

  warning('You may wish to try HELP on QCSTATION, BRUSH, or LINKDATA');
